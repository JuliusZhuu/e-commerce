...
-- Records of banner
-- ----------------------------
INSERT INTO `banner` VALUES (1, '合作 谁是你的菜', NULL, 'http://192.168.1.123/eecommerce/images/31da695c84cabd0eaff054265da29e5c.jpg', '合作 谁是你的菜', 1, NULL);
INSERT INTO `banner` VALUES (2, '活动 美食节', '', 'http://192.168.1.123/eecommerce/images/baea18aa59217cabd190b19fc1cf1617.jpg', '活动 美食节', 0, NULL);
INSERT INTO `banner` VALUES (3, '活动 母亲节', NULL, 'http://192.168.1.123/eecommerce/images/d5683f01e132851229be21c52d808b62.jpg', '活动 母亲节', 0, NULL);
INSERT INTO `banner` VALUES (4, '活动 母亲节', NULL, 'http://192.168.1.123/eecommerce/images/af7d906e174cb160ab5a979310aa223d.jpg', '活动 母亲节', 0, NULL);
...
-- ----------------------------
INSERT INTO `cart_list` VALUES (1, 'julius', 1001, '日式和风懒人沙发', 599.00, 599.00, 22, 'http://yanxuan.nosdn.127.net/149dfa87a7324e184c5526ead81de9ad.png', '1', NULL, 0);
INSERT INTO `cart_list` VALUES (3, 'julius', 1008, '日式蓬软太鼓抱枕', 29.00, 29.00, 10, 'http://yanxuan.nosdn.127.net/ad953e16ad8c33b714e7af941ce8cd56.png', '1', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品信息顶部轮播图' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品常见问题表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `role`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'ROLE_user' COMMENT '角色名称,默认注册为普通用户',
  ...
  CONSTRAINT `role_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 'ROLE_user', '', 1);
...
CREATE TABLE `user`  (
  ...
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3140403455,2984550794&fm=26&gp=0.jpg' COMMENT '头像地址',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'julius', '$2a$10$9knAB9Ju.WrJXnJWSf2Fk.2DjZotvVBfEfFpfvGmtcG3JDWZDynQG', '用户ee0d8ef6', 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3140403455,2984550794&fm=26&gp=0.jpg', NULL);
INSERT INTO `user` VALUES (2, 'lili', '$2a$10$9knAB9Ju.WrJXnJWSf2Fk.2DjZotvVBfEfFpfvGmtcG3JDWZDynQG', '用户ee0d8ef6', 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3140403455,2984550794&fm=26&gp=0.jpg', NULL);
INSERT INTO `user` VALUES (3, 'lucy', '123', NULL, 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3140403455,2984550794&fm=26&gp=0.jpg', NULL);
INSERT INTO `user` VALUES (4, 'aaa', '123', NULL, 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3140403455,2984550794&fm=26&gp=0.jpg', NULL);
INSERT INTO `user` VALUES (7, '123456789', '123', NULL, 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3140403455,2984550794&fm=26&gp=0.jpg', NULL);
